  ...
  return (
    <div>
      ...
      <section style={{ height: '100vh', padding: 0, overflow: 'hidden', position: 'relative', display: 'flex', alignItems: 'center' }}>
          ...
          <div className="grid-2" style={{ alignItems: 'center' }}>
            ...
            >
              ...
              <div style={{ display: 'flex', gap: '1.5rem' }}>
                ...
                <Link to="/impact" className="nav-btn" style={{ border: '1px solid var(--border-subtle)', padding: '1.5rem 3rem', fontSize: '1.1rem', textDecoration: 'none' }}>Esplora i Reportage</Link>
              </div>
            </motion.div>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <div className="main-card desktop-only" 
                style={{ 
                  ...
                  padding: '1.5rem', background: 'var(--accent-purple)', color: 'var(--bg-main)',
        ...
        >
          <ChevronDown size={24} color="var(--text-muted)" style={{ opacity: 0.5 }} />
        </motion.div>
      </section>
        ...
        <div className="content-box">
          <div className="grid-2" style={{ gap: '6rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '2rem' }}>
               <div className="main-card" style={{ background: 'var(--bg-main)', padding: '3rem' }}>
               ...
               <div className="main-card" style={{ background: 'var(--accent-purple)', color: 'var(--bg-main)', padding: '3rem' }}>
      ...
      <section style={{ background: 'var(--text-main)', color: 'var(--bg-main)' }}>
        <div className="content-box">
           <div className="grid-2" style={{ alignItems: 'center' }}>
              <div style={{ position: 'relative' }}>
                 <motion.img 
              ...
              <div>
                 <div className="feature-pill" style={{ background: 'var(--accent-purple)', color: 'var(--bg-main)', border: 'none', marginBottom: '2rem' }}>IMPACT STORY360</div>
      ...
      <section style={{ background: 'var(--bg-main)', borderTop: '1px solid var(--border-subtle)' }}>
        <div className="content-box">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem' }}>
             ...
             <div className="main-card" style={{ padding: '3rem', border: '2px solid var(--accent-purple)' }}>
